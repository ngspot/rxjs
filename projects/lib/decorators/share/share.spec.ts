...
abstract class TestClass {
  ...
  abstract testMethod(arg1: string, arg2: number, scheduler: VirtualTimeScheduler): Observable<any>;
}

interface Obj { arg1: string; arg2: number; }
...
describe('@Share()', () => {
  ...
  describe('GIVEN: second subscribe before first one flushes', () => {
    When(() => {
      ...
      classUnderTest.testMethod(call1Args.arg1, call1Args.arg2, call1).subscribe();
      classUnderTest.testMethod(call2Args.arg1, call2Args.arg2, call2).subscribe();
      call1.flush();
      call2.flush();
    });
